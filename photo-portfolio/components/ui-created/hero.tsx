                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16 items-center">
                    ...
                    <div className="lg:order-last">
                        ...
                        <p className="mt-4 text-lg text-muted-foreground">
                            Welcome to Olivia Frzop's photography portfolio.
                            With an eye for detail and a passion for
                            storytelling, Olivia creates stunning images that
                            capture the essence of life's most precious moments.
                            From breathtaking landscapes to intimate portraits,
                            each photograph is a work of art that speaks to the
                            soul.
                        </p>
                        <div className="mt-8">
                            <Button asChild>
